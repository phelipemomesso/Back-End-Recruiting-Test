...
class UserController extends Controller
{
    ...
    {
        $resource = $this->service->index()->paginate();
    ...
    public function store(UserRequest $request)
    {
        ...
        $data = UserResource::make($this->service->find($entity->{$entity->getKeyName()}));
    ...
    public function update(UserRequest $request, $id)
    {
        ...
        return UserResource::make($this->service->find($entity->{$entity->getKeyName()}));
    }
